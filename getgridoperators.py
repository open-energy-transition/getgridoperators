names = [
    "RTE", "International Renewable Energy Agency", "International Energy Agency", "AltaLink", "ATCO", "BC Hydro", "Emera Incorporated", "ENMAX Power Corporation",
    ...
    "Azerenergy OJSC",
    "Tariff (Price) Council of Azerbaijan",
    "Azerbaijan Energy Regulatory Agency",
    "Electricity and Water Authority (EWA)",
    "National Electricity and Water Company (NEWC)",
    "Electricity and Water Regulatory Authority (EWRA)",
    "Power Grid Company of Bangladesh PLC",
    ...
    "Iran Grid Management Co (Tavanir)",
    "Ministry of Energy (Iran)",
    "Iraqi Electricity Transmission Company",
    "Ministry of Electricity (Iraq)",
    "Israel Electric Corporation",
    "National Grid (Israel)",
    "Electricity Authority (Israel)",
    "TEPCO",
    "Chubu Electric",
    "J-Power Transmission Network Co",
    "Agency for Natural Resources and Energy (Japan)",
    "National Electric Power Company (Jordan)",
    "Electricity Regulatory Commission (Jordan)",
    "Kazakhstan Electricity Grid Operating Company (KEGOC)",
    "Agency for Regulation of Natural Monopolies (Kazakhstan)",
    "Ministry of Electricity & Water (Kuwait)",
    "Electric Stations of Kyrgyzstan",
    "State Department of Fuel & Energy Regulation (Kyrgyzstan)",
    "Electricite du Laos",
    "Ministry of Energy and Mines (Laos)",
    "Electricite du Liban",
    "Electricity Regulatory Authority (Lebanon)",
    "Tenaga Nasional Berhad",
    "Sarawak Energy",
    "Sabah Electricity",
    ...
    "FENAKA",
    "Utility Regulatory Authority (Maldives)",
    "Mongolia State Power Transmission Grid",
    "Energy Regulatory Authority (Mongolia)",
    "Myanmar Electric Power Enterprise",
    "Electricity Regulatory Body (Myanmar)",
    "Nepal Electricity Authority",
    "Electricity Regulatory Commission (Nepal)",
    "Korea Electric Power Corporation (DPRK)",
    "Oman Electricity Transmission Company",
    "Authority for Electricity Regulation (Oman)",
    "National Transmission & Despatch Co",
    ...
    "Saudi Electricity Company",
    "National Grid SA",
    "Water & Electricity Regulatory Authority (Saudi Arabia)",
    "SP PowerGrid",
    ...
    "Electricity Regulatory Authority (Syria)",
    "Barki Tojik",
    ...
    "Electricity and Water Sector Regulatory Authority",
    ...
    "Uzbekenergo",
    "State Committee for Competition and Tariffs (Uzbekistan)",
    "Vietnam Electricity",
    "EVN National Power Transmission Corporation",
    "Electricity Regulatory Authority of Vietnam",
    "Yemen Electricity Holding Company",
    "Electricity Sector Regulatory Board (Yemen)",
    "Palestine Electricity Transmission Company",
    "Palestinian Public Utilities Regulatory Authority",
    ...
    "Energy Sector Development Office (Macau)",
    "Botswana Energy Regulatory Authority (BERA)",
    "Egyptian Electric Utility and Consumer Protection Regulatory Agency",
    "Malawi Energy Regulatory Authority (MERA)",
    "Energy and Petroleum Regulatory Authority (EPRA)",
    ...
    "North African Power Pool (COMELEC)",
    ...
    "L’Office National d’Electricité et de l’Eau Potable",
    "Electricidade de Moçambique",
